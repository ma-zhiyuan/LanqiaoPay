	...
	<body>
		...
		<div id="page">
			<div class="layout reg-wrapper">
				...
				<form:form class="form-bd reg-pay-bd" action="${applicationScope.url }/enterprise/registA" id="demoForm" modelAttribute="enterpriseUser">
					<div class="form-tab">
						<ul class="form-tab-hd clearfix">
							<a class="tab-item-b" href="">
							...
							<div class="form-item">
								...
								<div class="form-entity">
									<div class="form-field">
										<form:input class="ipt" type="text" id="email" path="email" value="" placeholder="请输入邮箱" />
