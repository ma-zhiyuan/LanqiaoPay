...
<script type="text/javascript">
   $(function(){
	$(":submit").click(function(){
		var id = $("[name=id]").val();
		var payPassword1 = $("[name=payPassword]").val();
		var payPassword = md5(payPassword1);
		var url = "userController/registPayPwd";
		var args = {"time":new Date(),"id":id,"payPassword":payPassword};
		var tag = 0;
		$.ajax({
			type: 'POST',
			async: false,
...
<script type="text/javascript">
	$(function() {
		...
		$("#email").blur(function() {
			...
			email = $.trim(email);
			//邮箱的正则表达式
			var url = "userController/registEmail";
			var args = {
				"id" : id,
				"email" : email,
				"time" : new Date() 
...
<body>
	...
	<div id="header">
		<div class="layout">
			<div id="logo">
				<a href=userController/to_uc> <img src="<%=basePath %>resources/styles/images/logo.png" alt="蓝桥" />
				</a>
			</div>
	...
	<div class="main layout">
		...
		<div class="col-main">
			...
			<div class="main-bd">
				...
				<form class="form-bd" action="userController/updateEmail"
					id="demoForm">
